    ...
    <section class="pages">
        <div class="container">
            ...
            <p data-aos="fade-up" data-aos-delay="100">
                Мы стремимся обеспечить высокое качество наших экспертных материалов и консалтинговых услуг. 
                Если вы не удовлетворены сервисом <strong><?= $domainTitle ?></strong>, ознакомьтесь с правилами возврата денежных средств.
            </p>
            ...
            <div class="contact-cards">
                <div class="contact-card" data-aos="zoom-in" data-aos-delay="200">
                    ...
                    <p>Если содержание материалов существенно отличается от заявленной программы на платформе <?= $domainTitle ?>.</p>
                </div>
                ...
                <div class="contact-card" data-aos="zoom-in" data-aos-delay="300">
                    ...
                    <p>Критические неисправности на стороне <?= $fullDomain ?>, делающие доступ к услугам невозможным.</p>
                </div>
                ...
                <div class="contact-card" data-aos="zoom-in" data-aos-delay="400">
                    ...
                    <p>Право на отказ в течение 14 дней с момента оплаты (при условии отсутствия полного доступа к контенту).</p>
                </div>
            </div>
            ...
            <div class="policy-details" style="margin-top: 40px;">
                ...
                <ol class="custom-list" data-aos="fade-up">
                    <li>Отправьте письмо на наш email: <a href="mailto:hello@<?= $fullDomain ?>" class="contact-link">hello@<?= $fullDomain ?></a>.</li>
                    <li>Укажите тему: «Запрос на возврат средств».</li>
                    <li>Укажите ваше имя, email регистрации и название программы.</li>
                    <li>Подробно опишите причину запроса со ссылкой на пункты условий.</li>
                    <li>Срок рассмотрения заявки нашей службой поддержки — до 3-х рабочих дней.</li>
                </ol>

                <h2 data-aos="fade-up">Сроки и способ возврата</h2>
                <p data-aos="fade-up">
                    После одобрения средства возвращаются в течение 7–14 рабочих дней тем же способом, которым была совершена оплата. 
                    Фактический срок зачисления зависит от регламента вашего банка в <strong>Великобритании (UK)</strong> или стране вашего пребывания.
                </p>
                ...
                <ul data-aos="fade-up">
                    ...
                    <li>Проблемы с доступом вызваны техническими неисправностями на стороне пользователя.</li>
                    <li>Нарушение условий Пользовательского соглашения <?= $domainTitle ?> с вашей стороны.</li>
                </ul>
            </div>
            ...
            <div class="contact-extra" data-aos="fade-up">
                ...
                <p>
                    По всем вопросам, связанным с возвратом или условиями консультаций, пожалуйста, обращайтесь:
                </p>
