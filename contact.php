...
<head>
    ...
    <title>
        <?= $domainTitle ?> — Innowacja na wyciągnięcie ręki
    </title>
    <link rel="icon"
        ...
        <div class="container">
            ...
            <div class="contact-cards">
                <div class="contact-card" data-aos="zoom-in" data-aos-delay="200">
                    ...
                    <h2>Napisz do nas</h2>
                    <p>W przypadku pytań ogólnych, sugestii i zapytań o konsulting:</p>
                    <a href="mailto:hello@opti-piler.org" class="contact-link">hello@opti-piler.org</a>
                </div>
                ...
                <div class="contact-card" data-aos="zoom-in" data-aos-delay="300">
                    ...
                    <a href="tel:+48228122949" class="contact-link">+48 22 812 29 49</a>
                </div>
            ...
            <div class="contact-extra" data-aos="fade-up" data-aos-delay="500">
                <p>
                    ...
                    <a href="./#contact" class="link-underlined">stronie głównej</a>, aby szybko wysłać zapytanie.
                </p>
                <br>
            </div>
        </div>
