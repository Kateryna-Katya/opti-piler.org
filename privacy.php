    ...
    <section class="pages">
        <div class="container">
            ...
            <p data-aos="fade-up" data-aos-delay="100">
                ...
                формате, включая техническую поддержку и информационное сопровождение.
            </p>
            ...
            <div class="contact-cards">
                <div class="contact-card" data-aos="zoom-in" data-aos-delay="200">
                    ...
                    <h2>Сбор данных</h2>
                    <p><?= $domainTitle ?> собирает данные только с вашего согласия для предоставления качественных консалтинговых услуг.</p>
                </div>
                ...
                <div class="contact-card" data-aos="zoom-in" data-aos-delay="300">
                    ...
                    <h2>Безопасность</h2>
                    <p>Мы используем современные протоколы шифрования и комплекс мер для предотвращения утечки вашей информации.</p>
                </div>
                ...
                <div class="contact-card" data-aos="zoom-in" data-aos-delay="400">
                    ...
                    <h2>Хранение</h2>
                    <p>Данные хранятся до момента достижения цели обработки или до официального отзыва согласия пользователем.</p>
                </div>
            </div>

            <div class="policy-details" style="margin-top: 40px;">
                <p data-aos="fade-up">
                    <strong><?= $domainTitle ?></strong> оставляет за собой право вносить изменения в Политику. Предоставляя свои данные, вы даете полное согласие на их обработку способами, предусмотренными настоящим документом.
                </p>
                ...
                <ul data-aos="fade-up">
                    ...
                    <li>Посещаемые страницы и просмотры инфоблоков;</li>
                    <li>Номер телефона (при звонке по контактам сайта).</li>
                </ul>

                <h2 data-aos="fade-up">Информация о действиях</h2>
                <ul data-aos="fade-up">
                    <li>Данные о контрактах и экспертных программах;</li>
                    <li>Запросы через формы обратной связи;</li>
                    <li>Произведенные платежи в соответствии с законодательством UK и ЕС.</li>
                </ul>

                <h2 data-aos="fade-up">Передача данных</h2>
                <p data-aos="fade-up">
                    Мы не предоставляем данные третьим лицам, за исключением прямого согласия пользователя или требований компетентных органов Великобритании (UK).
                </p>

                <h2 data-aos="fade-up">Использование Cookies</h2>
                <p data-aos="fade-up">
                    Файлы cookie помогают нам анализировать трафик и сохранять ваши предпочтения (например, настройки региона), чтобы сделать использование сайта максимально эффективным. Вы можете отключить их в настройках браузера.
                </p>
            </div>
            ...
            <div class="contact-extra" data-aos="fade-up">
                ...
                <p>
                    Если вы хотите отредактировать свои данные или полностью прекратить их обработку в соответствии с GDPR, 
                    свяжитесь с командой <strong><?= $domainTitle ?></strong>:
                </p>
