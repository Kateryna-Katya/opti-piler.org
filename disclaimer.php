    ...
    <section class="pages">
        <div class="container">
            ...
            <p data-aos="fade-up" data-aos-delay="100">
                ...
                рассмастриваться как персональная инвестиционная рекомендация,
            ...
            <div class="contact-cards">
                <div class="contact-card" data-aos="zoom-in" data-aos-delay="200">
                    ...
                    <p>Любая деятельность, связанная с финансами и инвестициями, сопряжена с рисками. Вы действуете на свой страх и риск.</p>
                </div>
                ...
                <div class="contact-card" data-aos="zoom-in" data-aos-delay="300">
                    ...
                    <p>Прошлые результаты не гарантируют аналогичных показателей в будущем. Индивидуальные итоги зависят от рыночных условий.</p>
                </div>
                ...
                <div class="contact-card" data-aos="zoom-in" data-aos-delay="400">
                    ...
                    <p>Администрация <?= $domainTitle ?> не несет ответственности за убытки, возникшие в результате использования материалов сайта.</p>
                </div>
            </div>

            <div class="policy-details" style="margin-top: 40px;">
                <p data-aos="fade-up">
                    <strong>Специфика рынка:</strong> Индивидуальные итоги вашей деятельности зависят от множества факторов, включая рыночные условия в Великобритании (UK) и ЕС, и могут существенно отличаться от приведенных примеров. Контент платформы <strong><?= $domainTitle ?></strong> собирается из источников, которые считаются надежными на момент публикации.
                </p>
